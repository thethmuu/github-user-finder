class UI {
    ...
    showProfile(user) {
        ...
        <div class="card card-body mb-3">
            <div class="row">
                <div class="col-md-3">
                    <img src="${user.avatar_url}" class="img-fluid mb-2" alt="User Avatar">
                    <a href="${user.html_url}" target="_blank" class="btn btn-success btn-block mb-4">
                        View Profile
                    </a>
                </div>
                <div class="col-md-9">
        ...
        <div class="card card-body mb-2">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <span class="badge badge-pill badge-dark">Watchers: ${repo.watchers_count}</span>
